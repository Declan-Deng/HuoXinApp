  ...
  async function hasAndroidPermission() {
    const checkPermissions = async () => {
      if (Platform.Version >= 33) {
        // Check both read and write permissions for media on Android 33+
        const permissions = [
          PermissionsAndroid.PERMISSIONS.READ_MEDIA_IMAGES,
          PermissionsAndroid.PERMISSIONS.READ_MEDIA_VIDEO,
          PermissionsAndroid.PERMISSIONS.WRITE_MEDIA_IMAGES,
          PermissionsAndroid.PERMISSIONS.WRITE_MEDIA_VIDEO,
        ];
        ...
        // Check read and write external storage permissions for older versions
    ...
    const requestPermissions = async () => {
      if (Platform.Version >= 33) {
        // Request both read and write permissions for media on Android 33+
        const permissions = [
          PermissionsAndroid.PERMISSIONS.READ_MEDIA_IMAGES,
          PermissionsAndroid.PERMISSIONS.READ_MEDIA_VIDEO,
          PermissionsAndroid.PERMISSIONS.WRITE_MEDIA_IMAGES,
        ...
        // Request read and write external storage permissions for older versions
