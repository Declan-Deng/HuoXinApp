...
// 在需要时调用此函数来进行设备的动态注册并保存DeviceSecret
// 仅在你知道DeviceSecret未保存或需要更新时调用
dynamicRegisterAndSave(deviceName);
